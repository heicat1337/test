...
<meta property="og:image" content="{{ $ogImage ?? $baseUrl . '/og/default.svg' }}">
<meta name="twitter:card" content="summary_large_image">
<meta name="twitter:title" content="{{ $title }}">
<meta name="twitter:description" content="{{ $description }}">
<meta name="twitter:image" content="{{ $ogImage ?? $baseUrl . '/og/default.svg' }}">
...
<div class="wrap">
    ...
    <footer>玄猫Web3 — 探索去中心化世界
        · <a href="{{ $baseUrl }}/about" style="color:#94a3b8">关于</a>
        · <a href="{{ $baseUrl }}/contact" style="color:#94a3b8">联系</a>
        · <a href="{{ $baseUrl }}/privacy" style="color:#94a3b8">隐私</a>
        · <a href="{{ $baseUrl }}/terms" style="color:#94a3b8">条款</a>
        · <a href="{{ $baseUrl }}/sitemap.xml" style="color:#94a3b8">sitemap</a>
    </footer>
</div>
</body>
</html>
